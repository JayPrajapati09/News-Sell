			...
			<% }
			   %>
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder=" " name="o_pass" required="required">
					<label class="col-form-label">Enter New Password</label>
					<input type="text" class="form-control" placeholder=" " name="n_pass" required="required">
