...
<div class="agile-main-top">
	...
	<div class="d-center">
		<div class="modal-header">
			<h5 class="modal-title text-center">Buyer Log in</h5>
		</div>
			...
			<form action="BuyerController" method="post">
					...
					<% }
			   		%>
					    ...
					    <a href="buyer_forgot_password.jsp"><input type="button" name="action"class="form-control" value="Forgot Password"></a>
						</div>
			    </form>
				</div>
			</div>
