...
<div class="agile-main-top">
 ...
 <div class="d-center">
		<div class="modal-header">
			<h5 class="modal-title text-center">Verify Email</h5>	
		</div>
		<div class="modal-body">
			...
			%>
				<div class="form-group">
					...
					<input type="hidden" class="form-control" placeholder=" " name="fpass" value="fpass">
					<input type="text" class="form-control" placeholder=" " name="email" required="required">
				</div>
				<div class="right-w3l">
					<input type="submit" name="action"class="form-control" value="Verify Email">
				</div>
			</form>
